# -*- coding: utf-8 -*-
"""
Created on Fri Nov 13 14:33:44 2015
...
google_username = "vknitin@gmail.com"
google_password = "Boilers@28"
path = "C:/Users/nvallapuneni/Desktop/Leapfrog"

# connect to Google
connector = pyGTrends(google_username, google_password)

# make request
connector.request_report("Chamberlain")

# wait a random amount of time between requests to avoid bot detection
time.sleep(randint(5, 10))

# download file
connector.save_csv(path, "Chamberlain")
